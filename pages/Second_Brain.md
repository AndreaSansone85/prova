...
- **Connessione**: Deve avere un titolo chiaro (es. "Differenza tra ansia e stress") e, se possibile, un collegamento ad altre note che hai già scritto. Ad esempio, la nota dal titolo "l'ipertiroidismo può causare eiaculazione precoce" si potrebbe collegare a una nota dal titolo "segni e sintomi di ipertiroidismo", o "cosa provoca l'eiaculazione precoce".
- **Autonomia**: La nota deve essere comprensibile anche se la leggi tra tre mesi, senza dover riaprire il libro originale. Questa è la parte fondamentale, perché l'idea è che tu non debba ogni volta rileggere il teso originale per ricordarti cosa diceva.
